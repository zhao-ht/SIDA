...
__C.MODEL.USE_BOTTLENECK=False
__C.MODEL.BOTTLENECK_DIMS=256

__C.MODEL.CLASSAWARE=True

__C.MODEL.TRAIN_SOURCE_ONLY=False

__C.FIXED.IMPORTANTWEIGHT=True

__C.TRAIN.WRITER_FLAG=True

__C.CLUSTERING.METHOD = 'KMEANS'
__C.CLUSTERING.SAVE=False





__C.SIDA.CONSISTENCY = 'infomax'  # ['forward','infomax']
__C.SIDA.INFOMETHOD = 'NWJ'       #['NCE,NWJ]
__C.SIDA.Q_OPTIMIZATION_METHOD='NONE'   #['SEARCH','PROPAGATION','NONE']
__C.SIDA.WEIGHT_BY_LABEL = True

__C.SIDA.CDDONLOGITS=False
__C.SIDA.INFOONLOGITS=False
__C.SIDA.SQUAREONLOGITS=True
__C.SIDA.INFOCOEF=1.0
__C.SIDA.MARGIN=1
__C.SIDA.POS_MARGIN=0.2
__C.SIDA.NEG_MARGIN=1.0
__C.SIDA.TYPE_OF_TRIPLETS='all'
__C.SIDA.INFOCOEF_2=1.0
__C.SIDA.INFOCOEF_SQUARE=1.0
__C.SIDA.MARGIN_2=1
__C.SIDA.POS_MARGIN_2=0.0
__C.SIDA.NEG_MARGIN_2=1.0
__C.SIDA.ALIGNMENT_FEAT_KEYS=['feat', 'probs']
__C.SIDA.DISTANCES=['LpDistance','LpDistance']   #LpDistance,CosineSimilarity
__C.SIDA.MINER='TripletMarginMiner'   #[PairMarginMiner,TripletMarginMiner]

__C.SIDA.TOP_K=3
__C.SIDA.PROP_MAX_STEP=3
__C.SIDA.PROP_ALPHA=0.5
__C.SIDA.PROP_BETA=0.05
__C.SIDA.GRAPH_METHOD='KNN'
__C.SIDA.PROP_ADVER=False

__C.SIDA.MIN_ENTROPY_PER_CLASS=0.7


__C.SIDA.MARGIN_FROM_SOURCE=True

__C.SIDA.CLASSIFYCOEF=1.0
...
__C.TRAIN.SAVE_CKPT_INTERVAL = 1 # percentage of total iterations in each loop
...
__C.CLUSTERING.TARGET_DATASET_TYPE = 'SingleDataset'
